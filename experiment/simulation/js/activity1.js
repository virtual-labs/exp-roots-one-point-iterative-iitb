...
function activity1() {
   ...
   <h4 class="center-text fs-28px fb-700">Roots of Equation: One Point Iterative Method</h4>
   <br><br>
...
function equ_inp() {
    ...
    if (sel_inp.value != '0') {
        btn.disabled = false;
        equ = sel_inp.value;
        g_equ = g_equations[equations.indexOf(equ)];
    }
    else {
        btn.disabled = true;
        equ = '';
